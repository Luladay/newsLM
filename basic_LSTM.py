...
if __name__ == '__main__':
	...
	print ">>>>Learning rate"
	print "Running experiment 1..."
	train(train_matrix, train_labels, "./models/basic_lstm_hsize256 lr05", "Basic LSTM hsize256 lr01", 
		hidden_size=256, lr=0.005, RESUME=False, batch_size=256, n_epochs=45)
	print "Running experiment 2..."
	train(train_matrix, train_labels, "./models/basic_lstm_hsize300 lr05", "Basic LSTM hsize300 lr01", 
